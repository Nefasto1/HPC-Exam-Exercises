...
thin = [pd.read_csv(f"results/results_thin_preprocessed_{i}.txt", sep="\t") for i in range(1, thin_count)]
fixed_thin = [pd.read_csv(f"results/fixed_thin_preprocessed_{i}.txt", sep="\t") for i in range(1, fixed_thin_count)]
