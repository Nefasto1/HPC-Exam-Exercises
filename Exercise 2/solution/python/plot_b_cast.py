...
df_open2      = pd.read_csv(f"results/b_cast_openmp_2.txt", sep="\t")
...
for n in df_open["Size"].unique():
    ...
    tmp_open2      = df_open2[df_open2["Size"] == n]
    ...
    plt.plot(tmp_open2["np"].unique(), tmp_open2["Latency (ns)"]/1000, label="OpenMP 2")
